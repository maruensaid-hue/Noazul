  ...
  return (
    <View className="flex-1 bg-white dark:bg-gray-900">
      ...
      <Pressable
        ...
        className="flex-row items-center justify-between border-b border-gray-100 px-4 py-4 dark:border-gray-800"
      >
        <Text className="text-base text-gray-900 dark:text-gray-50">Gerenciar assinatura</Text>
        <Text className="text-gray-400 dark:text-gray-500">›</Text>
      </Pressable>
      ...
      <Pressable
        onPress={() => router.push(isPremium ? "/(main)/reports" : "/paywall")}
        className="flex-row items-center justify-between border-b border-gray-100 px-4 py-4 dark:border-gray-800"
      >
        <Text className="text-base text-gray-900 dark:text-gray-50">Relatórios</Text>
        {isPremium ? (
          <Text className="text-gray-400 dark:text-gray-500">›</Text>
        ) : (
          <Text className="text-sm font-medium text-brand-600">Premium</Text>
